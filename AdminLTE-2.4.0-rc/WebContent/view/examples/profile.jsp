							...
							<div class="tab-content">
								<div class="active tab-pane" id="activity">
									...
									<div class="post">
										<div class="user-block">
											<img class="img-circle img-bordered-sm"
												src="<%= request.getContextPath() %>/resources/dist/img/user1-128x128.jpg" alt="user image">
									...
									<div class="post clearfix">
										<div class="user-block">
											<img class="img-circle img-bordered-sm"
												src="<%= request.getContextPath() %>/resources/dist/img/user7-128x128.jpg" alt="User Image">
									...
									<div class="post">
										<div class="user-block">
											<img class="img-circle img-bordered-sm"
												src="<%= request.getContextPath() %>/resources/dist/img/user6-128x128.jpg" alt="User Image">
										...
										<div class="row margin-bottom">
											<div class="col-sm-6">
												<img class="img-responsive" src="<%= request.getContextPath() %>/resources/dist/img/photo1.png"
													alt="Photo">
											</div>
											<!-- /.col -->
											<div class="col-sm-6">
												<div class="row">
													<div class="col-sm-6">
														<img class="img-responsive"
															src="<%= request.getContextPath() %>/resources/dist/img/photo2.png" alt="Photo"> <br>
														<img class="img-responsive"
															src="<%= request.getContextPath() %>/resources/dist/img/photo3.jpg" alt="Photo">
													</div>
													<!-- /.col -->
													<div class="col-sm-6">
														<img class="img-responsive"
															src="<%= request.getContextPath() %>/resources/dist/img/photo4.jpg" alt="Photo"> <br>
														<img class="img-responsive"
															src="<%= request.getContextPath() %>/resources/dist/img/photo1.png" alt="Photo">
													</div>
													<!-- /.col -->
												</div>
												<!-- /.row -->
