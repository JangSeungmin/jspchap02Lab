				...
				<div id="visual">
					<div id="mySwipe" class='swipe'>
						<ul class="touch_banner swipe-wrap" style="text-align: center">
							<!--Â ë°°ë ëª©ë¡Â -->
							<li><a href="#"><img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_img_1.jpg" 
									alt="" /></a></li>
							<li><a href="#"><img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_img_2.jpg" 
									alt="" /></a></li>
							<li><a href="#"><img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_img_3.jpg" 
									alt="" /></a></li>
						</ul>
					</div>
					<ul class="touch_bullet">
						<!--Â ë°°ë ìì¹ íìÂ -->
						<li><img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_bullet_on.png" class="active"
							alt="" /></li>
						<li><img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_bullet_off.png" alt="" /></li>
						<li><img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_bullet_off.png" alt="" /></li>
					</ul>
					<p class="touch_left_btn">
						<!--Â ì´ì  ë²í¼Â -->
						<a href="#"> <img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_btn_left.png" alt="ì´ì  ë°°ë" />
						</a>
					</p>
					<p class="touch_right_btn">
						<!--Â ë¤ì ë²í¼Â -->
						<a href="#"> <img src="<%= request.getContextPath() %>/resources/pages/examples/images/visual_btn_right.png"
							alt="ë¤ì ë°°ë" />
						</a>
					</p>
				</div>
